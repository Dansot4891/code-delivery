...
RestaurantDetailModel _$RestaurantDetailModelFromJson(
    ...
    RestaurantDetailModel(
      ...
      products: (json['products'] as List<dynamic>)
          .map((e) =>
              RestaurantProduectModel.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
...
RestaurantProduectModel _$RestaurantProduectModelFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$RestaurantProduectModelToJson(
        RestaurantProduectModel instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
